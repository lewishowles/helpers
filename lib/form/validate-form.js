 ...
 * @helper validateForm
 * @category Form
 * @signature validateForm(fields: object, formData: object): Promise<{ valid, validated, results }>
 * @description
 ...
 * // }
 */
export async function validateForm(fields, formData) {
	...
	for (const fieldName in fields) {
		...
		const result = await validateField(fieldName, fieldRules, formData);
