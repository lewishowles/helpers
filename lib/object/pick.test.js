...
describe("pick", () => {
	...
	test("should pick properties from an object", () => {
		expect(pick(sampleObject, ["name", "profile"])).toEqual({
			name: "Sophie",
			profile: "linkedin/sophie",
		});
	});
	...
	test("should discard unknown properties", () => {
		expect(pick(sampleObject, ["name", "profile", "homepage"])).toEqual({
			name: "Sophie",
			profile: "linkedin/sophie",
		});
	});
	...
	test("should not modify the original object", () => {
		const object = { name: "Sophie", profile: "linkedin/sophie", colour: "purple" };

		pick(object, ["name"]);

		expect(object).toEqual({ name: "Sophie", profile: "linkedin/sophie", colour: "purple" });
	});
});
