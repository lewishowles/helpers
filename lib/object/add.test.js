...
describe("add", () => {
	...
	test("should add the key/value pair if the key exists but its value is undefined", () => {
		expect(
			add({ existing_key: "existing_value", second_key: undefined }, "second_key", "second_value"),
		).toEqual({
			existing_key: "existing_value",
	...
	test("should add the key/value pair if the key exists but its value is undefined null", () => {
		expect(
			add({ existing_key: "existing_value", second_key: null }, "second_key", "second_value"),
		).toEqual({
			existing_key: "existing_value",
			second_key: "second_value",
		});
